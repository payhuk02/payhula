-- Script pour créer/corriger la fonction get_user_product_recommendations
-- Version simplifiée qui gère les cas où les tables peuvent ne pas exister
...
'Retourne des recommandations personnalisées basées sur l''historique d''achat de l''utilisateur. Version améliorée avec gestion d''erreurs.';

-- Tester la fonction (remplacez par un UUID valide si nécessaire)
-- SELECT * FROM get_user_product_recommendations('00000000-0000-0000-0000-000000000000'::UUID, 6);
