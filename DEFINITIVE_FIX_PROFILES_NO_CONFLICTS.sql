-- ============================================================
-- CORRECTION DÉFINITIVE - Version sans conflits
...
-- 19. Test de création d'un profil de test
INSERT INTO public.profiles (
    user_id,
    display_name,
    first_name,
...
-- 20. Vérifier que le profil a été créé
SELECT 
    id,
    user_id,
    display_name,
...
-- 21. Nettoyer le profil de test
DELETE FROM public.profiles 
WHERE user_id = '00000000-0000-0000-0000-000000000001';

-- 22. Message de confirmation final
...
-- ============================================================
-- FIN DE LA CORRECTION DÉFINITIVE (VERSION SANS CONFLITS)
-- ============================================================
-- 
-- INSTRUCTIONS:
...
--
-- Cette version gère les conflits de politiques existantes.
-- ============================================================
