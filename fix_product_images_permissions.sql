...
-- 4. Vérifiez que le bucket est public dans Storage → product-images → Settings
-- ============================================================
...
-- 1. Le bucket est public : SELECT * FROM storage.buckets WHERE id = 'product-images';
-- 2. Les politiques existent : SELECT * FROM pg_policies WHERE tablename = 'objects' AND policyname LIKE 'product-images%';
-- ============================================================
