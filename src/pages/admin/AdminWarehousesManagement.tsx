          ...
          <div className="container mx-auto p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold flex items-center gap-2 mb-1 sm:mb-2">
                  <div className="p-2 rounded-lg bg-gradient-to-br from-purple-500/10 to-pink-500/5 backdrop-blur-sm border border-purple-500/20 animate-in zoom-in duration-500">
                    <WarehouseIcon className="h-5 w-5 sm:h-6 sm:w-6 lg:h-8 lg:w-8 text-purple-500 dark:text-purple-400" aria-hidden="true" />
                  </div>
            ...
            <Tabs defaultValue="warehouses" className="space-y-4 sm:space-y-6">
              <TabsList className="grid w-full grid-cols-3 h-auto p-1 bg-muted/50 backdrop-blur-sm">
                ...
                >
                  <WarehouseIcon className="mr-1.5 sm:mr-2 h-3.5 w-3.5 sm:h-4 sm:w-4" />
                ...
                >
                  ...
                  <span className="hidden xs:inline">Transferts</span>
              ...
              <TabsContent value="transfers" className="space-y-4 sm:space-y-6 mt-4 sm:mt-6">
                <WarehouseTransfers />
              </TabsContent>
            </Tabs>
          </div>
