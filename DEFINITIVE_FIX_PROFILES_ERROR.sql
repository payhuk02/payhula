-- ============================================================
-- CORRECTION DÉFINITIVE - Erreur profiles.user_id
...
-- 15. Forcer la mise à jour du cache de schéma
SELECT pg_notify('pgrst', 'reload schema');

-- 16. Attendre un moment pour que le cache se mette à jour
SELECT pg_sleep(3);

-- 17. Vérifier la structure finale de la table
SELECT 
    column_name, 
    data_type, 
    is_nullable,
...
-- 18. Test de création d'un profil de test
INSERT INTO public.profiles (
    user_id,
    display_name,
    first_name,
...
-- 19. Vérifier que le profil a été créé
SELECT 
    id,
    user_id,
    display_name,
