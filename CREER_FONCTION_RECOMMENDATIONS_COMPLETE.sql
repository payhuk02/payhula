-- Script COMPLET pour créer la fonction get_user_product_recommendations
-- Exécutez ce script dans Supabase Dashboard → SQL Editor
-- Ce script inclut : CREATE FUNCTION, COMMENT, et GRANT

-- ============================================================
-- ÉTAPE 1 : Supprimer la fonction existante si elle existe
-- ============================================================
DROP FUNCTION IF EXISTS public.get_user_product_recommendations(UUID, INTEGER);

-- ============================================================
-- ÉTAPE 2 : Créer la fonction avec gestion d'erreurs défensive
-- ============================================================
...
-- ============================================================
-- ÉTAPE 3 : Ajouter un commentaire à la fonction
-- ============================================================
...
-- Si la requête ci-dessus retourne une ligne, la fonction est créée avec succès ✅
